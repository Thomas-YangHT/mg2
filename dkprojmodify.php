...
function  dkpjrela(){
         if(isset($_POST['adddkpj'])){     
             adddkpj();
         }
         if(isset($_POST['moddkpj'])){  
             mysqlgetdkpj();   
             updatedkpj();
         }
         if(isset($_POST['deldkpj'])){     
             mysqlgetdkpj();
             deldkpj();
         }
         mysqlgetdkpj();
...
function mysqlgetdkpj(){
  ...
  while($row=mysql_fetch_array($res))  {
   ...
   array_multisort($project, SORT_ASC, $dkprojects);
...
function adddkpj(){ 
  ...
  $SQL = "insert into  dockerproject(projname,projdir,ports,progdir,logdir,startscript,stopscript,location,dstwebapp,svnprojname) values('','','','','','','','','','')";
  writelog(date("Y.m.d H:i:sa l")." user: ".$_SESSION['user']." from ".$_SERVER['REMOTE_ADDR']." adddkpj sql:".$SQL);
...
function updatedkpj(){ 
  ...
  for ($i=0; $i<count($dkprojects); $i++) {
      if( !empty($_REQUEST["id".$dkprojects[$i]['Id']]) ){
           $SQL = "update dockerproject set ";
           $SQL.= " projname=\"".$_POST[id.$dkprojects[$i]['Id'].'projname']."\",";
           $SQL.= " projdir=\"".$_POST[id.$dkprojects[$i]['Id'].'projdir']."\",";
           $SQL.= " ports=\"".$_POST[id.$dkprojects[$i]['Id'].'ports']."\","; 
           $SQL.= " progdir=\"".$_POST[id.$dkprojects[$i]['Id'].'progdir']."\","; 
           $SQL.= " logdir=\"".$_POST[id.$dkprojects[$i]['Id'].'logdir']."\",";
           $SQL.= " startscript=\"".$_POST[id.$dkprojects[$i]['Id'].'startscript']."\","; 
           $SQL.= " stopscript=\"".$_POST[id.$dkprojects[$i]['Id'].'stopscript']."\","; 
           $SQL.= " location=\"".$_POST[id.$dkprojects[$i]['Id'].'location']."\",";
           $SQL.= " dstwebapp=\"".$_POST[id.$dkprojects[$i]['Id'].'dstwebapp']."\","; 		   
           $SQL.= " svnprojname=\"".$_POST[id.$dkprojects[$i]['Id'].'svnprojname']."\""; 
           $SQL.= " where Id=\"".$dkprojects[$i]['Id']."\"";
           writelog(date("Y.m.d H:i:sa l")." user: ".$_SESSION['user']." from ".$_SERVER['REMOTE_ADDR']." updatedkpj sql:".$SQL);
...
function deldkpj(){ 
  ...
  for ($i=0; $i<count($dkprojects); $i++) {
      if( !empty($_REQUEST["id".$dkprojects[$i]['Id']]) ){
           $SQL = "delete from dockerproject where Id=\"".$dkprojects[$i]['Id']."\"";
           writelog(date("Y.m.d H:i:sa l")." user: ".$_SESSION['user']." from ".$_SERVER['REMOTE_ADDR']." deldkpj sql:".$SQL);
...
function  show_dkpj_part1(){
     ...
     echo "<span class='navPoint' id='switchPoint1' title='关闭/打开'>5</span>docker项目编辑：</font>\n";
	 ...
	 echo "	<li style='width:2%'>&nbsp&nbsp</li><li style='width:8%'><div id='rkey'>Projname:</div></li>\n";
     echo "	<li style='width:10%'><div id='rkey'>Projdir:</div></li> \n";		
     echo "	<li style='width:7%'><div id='rkey'>Ports:</div></li> \n";
     echo "	<li style='width:13%'><div id='rkey'>Porgdir:</div></li> \n";
     echo "	<li style='width:13%'><div id='rkey'>Logdir:</div></li> \n";		
     echo "	<li style='width:7%'><div id='rkey'>Startscript:</div></li> \n";
     echo "	<li style='width:7%'><div id='rkey'>Stopscript:</div></li> \n";	 
     echo "	<li style='width:13%'><div id='rkey'>Location:</div></li> \n";		
     echo "	<li style='width:10%'><div id='rkey'>Dstwebapp:</div></li> \n";
     echo "	<li style='width:10%'><div id='rkey'>Svnprojname:</div></li> \n";	 	 
	 echo " </br>\n";

     for ($i=0; $i<count($dkprojects); $i++) {
            echo " <input type='checkbox' style='float:left' name='id".$dkprojects[$i]['Id']."' />\n";
            echo "	<li style='width:8%'><div id='rvalue'><input style='width:110%' type='text' name='id".$dkprojects[$i]['Id']."projname' value='".$dkprojects[$i]['projname']."'/></div></li>\n";
         	echo "	<li style='width:10%'><div id='rvalue'><input style='width:120%' type='text' name='id".$dkprojects[$i]['Id']."projdir' value='".$dkprojects[$i]['projdir']."'/></div></li> \n";		
         	echo "	<li style='width:7%'><div id='rvalue'><input style='width:100%' type='text' name='id".$dkprojects[$i]['Id']."ports' value='".$dkprojects[$i]['ports']."' /></div></li> \n";
         	echo "	<li style='width:13%'><div id='rvalue'><input style='width:150%' type='text' name='id".$dkprojects[$i]['Id']."progdir' value='".$dkprojects[$i]['progdir']."'/></div></li> \n";
         	echo "	<li style='width:13%'><div id='rvalue'><input style='width:150%' type='text' name='id".$dkprojects[$i]['Id']."logdir' value='".$dkprojects[$i]['logdir']."'/></div></li> \n";		
         	echo "	<li style='width:7%'><div id='rvalue'><input style='width:110%' type='text' name='id".$dkprojects[$i]['Id']."startscript' value='".$dkprojects[$i]['startscript']."' /></div></li> \n";
         	echo "	<li style='width:7%'><div id='rvalue'><input style='width:100%' type='text' name='id".$dkprojects[$i]['Id']."stopscript' value='".$dkprojects[$i]['stopscript']."'/></div></li> \n";			
         	echo "	<li style='width:13%'><div id='rvalue'><input style='width:150%' type='text' name='id".$dkprojects[$i]['Id']."location' value='".$dkprojects[$i]['location']."'/></div></li> \n";		
         	echo "	<li style='width:10%'><div id='rvalue'><input style='width:110%' type='text' name='id".$dkprojects[$i]['Id']."dstwebapp' value='".$dkprojects[$i]['dstwebapp']."' /></div></li> \n";
         	echo "	<li style='width:10%'><div id='rvalue'><input style='width:100%' type='text' name='id".$dkprojects[$i]['Id']."svnprojname' value='".$dkprojects[$i]['svnprojname']."'/></div></li> \n";		
		    echo " </br>\n";
     } 
     echo " </br>\n";
     echo "<input name='adddkpj' class='shiny-blue' type='submit' value='增加' onclick=''/> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp\n";
     echo "<input name='moddkpj' class='shiny-blue' type='submit' value='修改' onclick=''/> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp\n";
     echo "<input name='deldkpj' class='shiny-blue' type='submit' value='删除' onclick=''/> \n";     
     echo "</form>\n"; 
     echo "</ul> \n";
     echo "</div> \n";
